    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => {
                ...
                return <p style={{ background: `${percentage < 50 ? "#ff4979" : percentage < 80 ? "#ffb704" : "#2da254"}`, paddingInline: "2px", paddingBlock: "2px", width: "50px", color: "#fff", alignItems: "center", display: "flex", justifyContent: "center" }}>{percentage ? parseInt(percentage).toLocaleString() + "%" : ""}
                </p>;
            }
        },
        {
